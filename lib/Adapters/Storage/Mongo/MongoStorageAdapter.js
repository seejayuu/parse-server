...
var MongoStorageAdapter = exports.MongoStorageAdapter = function () {
  ...
  _createClass(MongoStorageAdapter, [{
    ...
    key: 'deleteFields',
    value: function deleteFields(className, fieldNames, pointerFieldNames, collectionPrefix, adaptiveCollection) {
      var _this7 = this;
      ...
      return adaptiveCollection.updateMany({}, collectionUpdate).then(function (updateResult) {
        return _this7.schemaCollection(collectionPrefix);
