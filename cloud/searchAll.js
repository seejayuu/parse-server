...
Parse.Cloud.define("searchAll", function(request, response) {
	...
	Parse.Promise.when(promises).then(function(results) {
		...
		try {
			...
			finalResults = _.sortBy(_.uniq(finalResults, function (a) { console.log(JSON.stringify(a)); return a["objectId"] }), function(a) { return Date.parse(a.get("createdAt")) }).reverse();
		}
		catch (e) {
			console.log(e);
		}
